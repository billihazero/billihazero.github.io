...
최근 면접을 보았습니다. 안타깝게도(당연하게도) 떨어졌지만... <br>
...
해당 프로젝트에서는 기존에 1 ~ 3 공장의 작업현황 화면이 각각 분리되어 있었으며, <br>
사용자는 본인이 속한 공장의 화면만 볼 수 있도록 설계되어 있었습니다. <br>

가장 단순한 방법은 공장별로 동일한 구조의 작업현황 화면을 각각 구현하고, <br>
...
3. 로그 저장을 통한 사용자 행위 추적
   ...
   PROGRAM_CONTROLLER, PROGRAM_FUNCTION, CREATED_AT 등의 정보를 기록하도록 하였으며,
...
2. Reverse Proxy 필터링
   Reverse Proxy(Nginx)를 통해 클라이언트 요청을 백엔드로 전달할 때 <br>
